...
export class UsersService {
  ...
  async findOneNotPass(conditions: FindConditions<UsersEntity>) {
    ...
    let options =  {select: ['id', 'cpf', 'firstName', 'lastName', 'email', 'createdDate', 'updatedDate'] };
  ...
  async update(id: string, data) {
    ...
    const options  = {select: ['id', 'cpf', 'firstName', 'lastName', 'email', 'createdDate', 'updatedDate'] }
    return await this.usersRepository.save(user);

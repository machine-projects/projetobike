...
<template>
  <div>
    <div
      ...
      <!-- Sidebar -->
      <div
        class="fixed flex flex-col left-0 w-14 hover:w-64 md:w-64 bg-blue-900 dark:bg-gray-900 h-full text-white border-none z-10 sidebar">
      ...
      <div class="h-full ml-14 mt-14 mb-10 md:ml-64">
          ...
          <div
            ...
            <div class="flex justify-center items-center w-14 h-14 bg-white rounded-full">
              <svg width="30" height="30" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                class="stroke-current text-blue-800 dark:text-gray-800">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 p-4 gap-4">
          ...
          <!-- Recent Activities -->
          <div class="flex flex-col min-w-0 break-words bg-gray-50 dark:bg-gray-800 w-full shadow-lg rounded">
            <div class="rounded-t mb-0 px-0 border-0">
              <div class="flex flex-wrap items-center px-4 py-2">
                <div class="w-full max-w-full flex-grow flex-1">
                      ...
                      <div class="flex items-center text-sm">
                        <div class="hidden w-8 h-8 mr-3 rounded-full md:block">
                          <img class="object-cover w-full h-full rounded-full"
                            ...
                            alt="" loading="lazy" />
                          <div class="inset-0 rounded-full shadow-inner" aria-hidden="true"></div>
                        </div>
                        <div>

...
const user = reactive<UserResponseData>(userStore.user)
  ...
  <div class="flex justify-center z-100">
    <div class="relative inline-block">
      ...
      <button @click="showUserMenu = !showUserMenu"
        ...
        <span class="mx-1">{{ user.firstName }} {{ user.lastName }}</span>
      ...
      <div v-if="showUserMenu"
        ...
        <router-link to="/dashboard"
          ...
          <!-- <img class="flex-shrink-0 object-cover mx-1 rounded-full w-9 h-9"
            ...
            alt="jane avatar"> -->
          <div class="mx-1">
            <h1 class="text-sm font-semibold text-gray-700 dark:text-gray-200">{{ user.firstName }} {{ user.lastName }}
            </h1>
        ...
        <router-link to="/dashboard/configuracoes"
          class="block px-4 py-3 text-sm text-gray-600 capitalize transition-colors duration-200 transform dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white">
          Configurações
        </router-link>
